...
if test "$PHP_CLI" != "no"; then
  ...
  PHP_SELECT_SAPI([cli],
    [program],
    [php_cli.c php_http_parser.c php_cli_server.c ps_title.c sapi_debug_helper.c php_cli_process_title.c],
  ...
  PHP_INSTALL_HEADERS([sapi/cli], [cli.h sapi_debug_helper.h])
fi
